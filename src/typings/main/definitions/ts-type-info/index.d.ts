...
export class GlobalDefinition {
    ...
    getFileOfDefinition(def: ClassDefinition | EnumDefinition | FunctionDefinition | NamespaceDefinition | InterfaceDefinition | TypeAliasDefinition | VariableDefinition): FileDefinition;
    getFileAndNamespacesToDefinition(def: ClassDefinition | EnumDefinition | FunctionDefinition | NamespaceDefinition | InterfaceDefinition | TypeAliasDefinition | VariableDefinition): { file: FileDefinition; namespaces: NamespaceDefinition[]; };
}
